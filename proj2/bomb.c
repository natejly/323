...
int main(int argc, char* argv[]) {
    ...
    printf("Welcome to my fiendish little bomb. You have 10 phases with\n");
    ...
    // The second phase is harder. No one will ever figure out how to
    input = read_line();
    phase_2(input);
    phase_defused();
    ...
    // So you got here. Well, you just wait!
    input = read_line();
    phase_10(input);
    phase_defused();
    printf("GAH I will have my revenge!!!!!!!!!!\n");
